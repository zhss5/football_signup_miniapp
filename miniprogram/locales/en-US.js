module.exports = {
  ...
  activity: {
    ...
    actions: {
      ...
      copyActivity: 'Copy Activity',
      subscribeRegistrationNotifications: 'Subscribe manager notices',
      registrationNotificationsSubscribed: 'Manager notices subscribed',
  ...
  activityCreate: {
    ...
    lateCancellationNoticeWindowHours: 'Late cancellation notice (hours)',
    lateCancellationNoticeWindowHoursPlaceholder: 'Hours before activity start',
    lateCancellationNoticeWindowHoursHint: 'Notify the activity creator when a participant cancels within this many hours before the start. Use 0 to disable.',
  ...
  toast: {
    ...
    registrationNotificationSubscribed: 'Manager notifications enabled',
    registrationNotificationNotEnabled: 'Manager notifications not enabled',
  ...
  errors: {
    ...
    lateCancellationNoticeWindowHoursRange: 'Late cancellation notice window must be an integer between 0 and 168 hours',
    ...
    registrationProfileJoinedOnly: 'Only joined registrations can be edited',
    registrationProfileProxyBlocked: 'Proxy registrations cannot be edited as personal profiles',
    registrationProfileLocked: 'Registration details cannot be edited after activity start',
