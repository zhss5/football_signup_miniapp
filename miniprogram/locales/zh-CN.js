module.exports = {
  ...
  activityCreate: {
    ...
    benchCapacity: '替补人数',
    benchCapacityPlaceholder: '替补人数',
    benchCapacityHint: '0 表示不设置替补。',
    totalSignupLimit: '总报名人数',
    totalSignupLimitPlaceholder: '总报名人数',
    totalSignupLimitHint: '由正式队容量与替补人数自动计算。',
  ...
  errors: {
    ...
    benchCapacityInvalid: '替补人数必须为非负整数',
    ...
    registrationNotFound: '未找到当前报名记录',
    registrationProfileJoinedOnly: '只有有效报名可以修改',
    registrationProfileProxyBlocked: '代报名不能作为个人报名资料修改',
    registrationProfileLocked: '活动开始后不能修改报名信息',
    ...
    benchQueueManagedAutomatically: '替补队列由系统自动管理',
...
module.exports.activity.status.pending = '\u5f85\u786e\u8ba4';
...
module.exports.activity.managerActionsTitle = '\u7ec4\u7ec7\u8005\u64cd\u4f5c';
...
module.exports.my.webAdminLoginConfirmContent =
  '\u5141\u8bb8\u8fd9\u4e2a\u6d4f\u89c8\u5668\u4f7f\u7528\u4f60\u7684\u7ba1\u7406\u5458\u8eab\u4efd\u767b\u5f55\uff1f';
module.exports.toast.webAdminLoginConfirmed = 'Web \u540e\u53f0\u5df2\u786e\u8ba4\u767b\u5f55';
module.exports.toast.webAdminLoginScanUnavailable = '\u5f53\u524d\u65e0\u6cd5\u626b\u7801';
module.exports.toast.webAdminLoginInvalidQr = '\u65e0\u6548\u7684\u767b\u5f55\u7801';
