const COVER_ASPECT_RATIO = 1.25;
const COVER_OUTPUT_WIDTH = 1000;
const COVER_OUTPUT_HEIGHT = 800;
const COVER_OUTPUT_QUALITY = 0.78;
const COVER_THUMB_OUTPUT_WIDTH = 500;
const COVER_THUMB_OUTPUT_HEIGHT = 400;
const COVER_THUMB_OUTPUT_QUALITY = 0.68;
