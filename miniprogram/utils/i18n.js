...
function translateErrorMessage(error, translate) {
  const mapping = {
    ...
    'Registration not found': 'errors.registrationNotFound',
    'Only joined registrations can be edited': 'errors.registrationProfileJoinedOnly',
    'Proxy registrations cannot be edited': 'errors.registrationProfileProxyBlocked',
    'Registration profile is locked after activity start': 'errors.registrationProfileLocked',
    ...
    'Only the organizer or an admin can add participants': 'errors.proxySignupNotAllowed',
    'Only the organizer or an admin can move registrations': 'errors.moveRegistrationNotAllowed',
