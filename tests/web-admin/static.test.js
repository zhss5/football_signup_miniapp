...
const WEB_ADMIN_ASSET_VERSION = '20260724-activity-detail-timeout';
...
test('web admin static shell keeps existing forms and action hooks with Chinese labels', () => {
  ...
  expect(html).toContain('data-activity-detail-loading-spinner');
  expect(html).toContain('data-activity-detail-loading-message');
  expect(html).toContain('data-action="retry-activity-detail"');
