...
34. Before each Web Admin static hosting deployment, advance every versioned CSS and JavaScript asset query token together so CloudBase/CDN caches cannot serve an old `app.js` against the new pagination contract.
