...
- completed in code: block regular same-user same-activity rejoin after three combined self-cancellations or organizer removals; activity organizers/admins are exempt
